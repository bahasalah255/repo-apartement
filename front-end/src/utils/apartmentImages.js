...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600" width="100%" height="100%" preserveAspectRatio="xMidYMid slice" role="img" aria-label="Apartment placeholder">
  <defs>
  ...
  <rect width="800" height="600" rx="0" fill="url(#g)" />
  ...
  <text x="400" y="485" font-family="Arial, sans-serif" font-weight="bold" font-size="28" text-anchor="middle" fill="#64748b">Pas d'image</text>
</svg>
`
